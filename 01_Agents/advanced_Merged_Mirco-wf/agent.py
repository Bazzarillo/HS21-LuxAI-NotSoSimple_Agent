...
tasks = [
    ...
    "Mantainer" # Searches for high density resource area
    ]

# Goals get updated in every round
# TODO: Might delete Goals alltogether as they seem redundant
goals = [
    ...
    for unit in player.units:
        ...
        if unit.is_worker() and unit.can_act():
            ...
            try:
                ...
                # TODO: Optimize, as this line creates an endless loop of unit tryning to mine as soon as there is space 
